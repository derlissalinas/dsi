...
totals = concat withDoubleRatio	
	...
	-- General
	--Logs
	++ $(p [| extractDate :: [Char] -> [Char] |] )
        ++ $(p [| getClass :: [Char] -> [Char] |] )
     {- ++ $(p [| isDate :: [[Char]] -> Bool |] )
        ++ $(p [| isHour :: [Char] -> Bool |] )
        ++ $(p [| isMinute :: [Char] -> Bool |] )
	++ $(p [| isSecond :: [Char] -> Bool |] )
	++ $(p [| isLogTime :: [[Char]] -> Bool |] )
	++ $(p [| getLogTimeArray :: [[Char]] -> [Char] |] )
	++ $(p [| getDateSpring :: [Char] -> [Char] |] )
	++ $(p [| getDateSpringArray :: [[Char]] -> [Char] |] )
	++ $(p [| getDateApacheAccess :: [Char] -> [Char] |] )
        ++ $(p [| getDateApacheAccessArray :: [[Char]] -> [[Char]] |] )
        ++ $(p [| getDateApacheError :: [Char] -> [Char] |] )
        ++ $(p [| getDateApacheErrorArray :: [Char] -> [[Char]] |] )
        -- ++ $(p [| getLogTime :: [Char] -> [Char] |] )
        -- ++ $(p [| getDate :: [Char] -> [Char] |] )
	--BORRAR ++ $(p [| extractDate :: [Char] -> [Char] |] )
	++ $(p [| extractApacheDate :: [Char] -> [Char] |] )
        ++ $(p [| extractApacheDate2 :: [Char] -> [Char] |] )
	++ $(p [| extractApacheDate3 :: [Char] -> [Char] |] )
	++ $(p [| extractApacheDate4 :: [Char] -> [Char] |] )
	++ $(p [| extractApacheDateArray4 :: [String] -> [Char] |] )
	++ $(p [| headMaybe :: [a] -> Maybe a |] )
	++ $(p [| headString :: String -> String |] )	 -}
        ++ $(p [| logLevelList :: [[Char]] |] )
        ++ $(p [| getLogLevelString :: [Char] -> [Char] |] )
        ++ $(p [| getLogLevelArray :: [[Char]] -> [Char] |] )
        ++ $(p [| isDot :: Char -> Bool |] )
        ++ $(p [| getLogMessage :: [Char] -> [Char] |] )
        ++ $(p [| getType :: [Char] -> [Char] |] )
	-- Fechas
    ...
    ++ $(p [| getMonthNameStringES :: [Char] -> [Char] |] )
    ++ $(p [| getMonthNameArrayES :: [[Char]] -> [Char] |] )
    ++ $(p [| getMonthNameStringDE :: [Char] -> [Char] |] )
    ++ $(p [| getMonthNameArrayDE :: [[Char]] -> [Char] |] )
    ++ $(p [| getMonthNameStringIT :: [Char] -> [Char] |] )
    ++ $(p [| getMonthNameArrayIT :: [[Char]] -> [Char] |] )
    ++ $(p [| getMonthNameStringPT :: [Char] -> [Char] |] )
    ++ $(p [| getMonthNameArrayPT :: [[Char]] -> [Char] |] )
    ++ $(p [| getMonthNameStringFR :: [Char] -> [Char] |] )
    ++ $(p [| getMonthNameArrayFR :: [[Char]] -> [Char] |] )
    ++ $(p [| getMonthNameStringCAT :: [Char] -> [Char] |] )
    ++ $(p [| getMonthNameArrayCAT :: [[Char]] -> [Char] |] )
    ++ $(p [| getMonthNameStringCRO :: [Char] -> [Char] |] )
    ++ $(p [| getMonthNameArrayCRO :: [[Char]] -> [Char] |] )
    ++ $(p [| getMonthNameStringDAN :: [Char] -> [Char] |] )
    ++ $(p [| getMonthNameArrayDAN :: [[Char]] -> [Char] |] )
    ++ $(p [| getMonthNameStringESP :: [Char] -> [Char] |] )
    ++ $(p [| getMonthNameArrayESP :: [[Char]] -> [Char] |] )
    ++ $(p [| getMonthNameStringFIN :: [Char] -> [Char] |] )
    ++ $(p [| getMonthNameArrayFIN :: [[Char]] -> [Char] |] )
    ++ $(p [| getMonthNameStringHUN :: [Char] -> [Char] |] )
    ++ $(p [| getMonthNameArrayHUN :: [[Char]] -> [Char] |] )
    ++ $(p [| getMonthNameStringIRL :: [Char] -> [Char] |] )
    ++ $(p [| getMonthNameArrayIRL :: [[Char]] -> [Char] |] )
    ++ $(p [| getMonthNameStringISL :: [Char] -> [Char] |] )
    ++ $(p [| getMonthNameArrayISL :: [[Char]] -> [Char] |] )
    ++ $(p [| getMonthNameStringLAT :: [Char] -> [Char] |] )
    ++ $(p [| getMonthNameArrayLAT :: [[Char]] -> [Char] |] )
    ++ $(p [| getMonthNameStringLUX :: [Char] -> [Char] |] )
    ++ $(p [| getMonthNameArrayLUX :: [[Char]] -> [Char] |] )
    ++ $(p [| getMonthNameStringMAL :: [Char] -> [Char] |] )
    ++ $(p [| getMonthNameArrayMAL :: [[Char]] -> [Char] |] )
    ++ $(p [| getMonthNameStringHOL :: [Char] -> [Char] |] )
    ++ $(p [| getMonthNameArrayHOL :: [[Char]] -> [Char] |] )
    ++ $(p [| getMonthNameStringPOL :: [Char] -> [Char] |] )
    ++ $(p [| getMonthNameArrayPOL :: [[Char]] -> [Char] |] )
    ++ $(p [| getMonthNameStringRUM :: [Char] -> [Char] |] )
    ++ $(p [| getMonthNameArrayRUM :: [[Char]] -> [Char] |] )
    ++ $(p [| getMonthNameStringSAM :: [Char] -> [Char] |] )
	++ $(p [| getMonthNameArraySAM :: [[Char]] -> [Char] |] )
	++ $(p [| getMonthNameStringSOM :: [Char] -> [Char] |] )
	++ $(p [| getMonthNameArraySOM :: [[Char]] -> [Char] |] )
	++ $(p [| getMonthNameStringSUA :: [Char] -> [Char] |] )
	++ $(p [| getMonthNameArraySUA :: [[Char]] -> [Char] |] )
	++ $(p [| getMonthNameStringSUE :: [Char] -> [Char] |] )
	++ $(p [| getMonthNameArraySUE :: [[Char]] -> [Char] |] )
	++ $(p [| getMonthNameStringSUN :: [Char] -> [Char] |] )
	++ $(p [| getMonthNameArraySUN :: [[Char]] -> [Char] |] )
	++ $(p [| getMonthNameStringTAG :: [Char] -> [Char] |] )
	++ $(p [| getMonthNameArrayTAG :: [[Char]] -> [Char] |] )
	++ $(p [| getMonthNameStringTUR :: [Char] -> [Char] |] )
	++ $(p [| getMonthNameArrayTUR :: [[Char]] -> [Char] |] )
	++ $(p [| getMonthNameStringUZB :: [Char] -> [Char] |] )
	++ $(p [| getMonthNameArrayUZB :: [[Char]] -> [Char] |] )
	++ $(p [| getMonthNameStringVIE :: [Char] -> [Char] |] )
	++ $(p [| getMonthNameArrayVIE :: [[Char]] -> [Char] |] )
	++ $(p [| getMonthNameStringXHO :: [Char] -> [Char] |] )
	++ $(p [| getMonthNameArrayXHO :: [[Char]] -> [Char] |] )
	++ $(p [| getMonthNameStringYOR :: [Char] -> [Char] |] )
	++ $(p [| getMonthNameArrayYOR :: [[Char]] -> [Char] |] )
	++ $(p [| getMonthNameStringZUL :: [Char] -> [Char] |] )
	++ $(p [| getMonthNameArrayZUL :: [[Char]] -> [Char] |] )    
	++ $(p [| getMonthNameAbstract :: [Char] -> [Char] |] )
	++ $(p [| convertMonth :: [Char] -> [Char] |] )
	++ $(p [| convertMonthES :: [Char] -> [Char] |] )
	++ $(p [| convertMonthDE :: [Char] -> [Char] |] )
	++ $(p [| convertMonthIT :: [Char] -> [Char] |] )
	++ $(p [| convertMonthPT :: [Char] -> [Char] |] )
	++ $(p [| convertMonthFR :: [Char] -> [Char] |] )
	++ $(p [| convertMonthCAT :: [Char] -> [Char] |] )
	++ $(p [| convertMonthCRO :: [Char] -> [Char] |] )
	++ $(p [| convertMonthDAN :: [Char] -> [Char] |] )
	++ $(p [| convertMonthESP :: [Char] -> [Char] |] )
	++ $(p [| convertMonthFIN :: [Char] -> [Char] |] )
	++ $(p [| convertMonthHUN :: [Char] -> [Char] |] )
	++ $(p [| convertMonthIRL :: [Char] -> [Char] |] )
	++ $(p [| convertMonthISL :: [Char] -> [Char] |] )
	++ $(p [| convertMonthLAT :: [Char] -> [Char] |] )
	++ $(p [| convertMonthLUX :: [Char] -> [Char] |] )
	++ $(p [| convertMonthMAL :: [Char] -> [Char] |] )
	++ $(p [| convertMonthHOL :: [Char] -> [Char] |] )
	++ $(p [| convertMonthPOL :: [Char] -> [Char] |] )
	++ $(p [| convertMonthRUM :: [Char] -> [Char] |] )
	++ $(p [| convertMonthSAM :: [Char] -> [Char] |] )
	++ $(p [| convertMonthSOM :: [Char] -> [Char] |] )
	++ $(p [| convertMonthSUA :: [Char] -> [Char] |] )
	++ $(p [| convertMonthSUE :: [Char] -> [Char] |] )
	++ $(p [| convertMonthSUN :: [Char] -> [Char] |] )
	++ $(p [| convertMonthTAG :: [Char] -> [Char] |] )
	++ $(p [| convertMonthTUR :: [Char] -> [Char] |] )
	++ $(p [| convertMonthUZB :: [Char] -> [Char] |] )
	++ $(p [| convertMonthVIE :: [Char] -> [Char] |] )
	++ $(p [| convertMonthXHO :: [Char] -> [Char] |] )
	++ $(p [| convertMonthYOR :: [Char] -> [Char] |] )
	++ $(p [| convertMonthZUL :: [Char] -> [Char] |] )
	++ $(p [| convertMonthAbstract :: [Char] -> [Char] |] )
