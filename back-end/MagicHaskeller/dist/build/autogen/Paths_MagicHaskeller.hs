...
libdir     = "/usr/local/lib/x86_64-linux-ghc-8.0.2/MagicHaskeller-0.9.6.6.1-3wpuh4ht9Bn1yGTZj5UiOf"
dynlibdir  = "/usr/local/lib/x86_64-linux-ghc-8.0.2"
datadir    = "/usr/local/share/x86_64-linux-ghc-8.0.2/MagicHaskeller-0.9.6.6.1"
...
getDynLibDir = catchIO (getEnv "MagicHaskeller_dynlibdir") (\_ -> return dynlibdir)
